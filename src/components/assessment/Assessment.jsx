  ...
  return (
    <div className="bg-base-100 rounded-box">
      <div className="flex gap-3 px-0 lg:px-5 border-b w-max min-w-full">
        <h1 className="text-xl font-semibold text-[#1C4980] my-auto hidden lg:block">
          Assessment
        </h1>
        ...
        <div className="tabs w-screen md:w-auto overflow-auto flex-nowrap px-2">
          <a
            href="#1"
            className="tab text-[0.875rem] px-2 md:px-4 whitespace-nowrap h-auto tab-bordered font-semibold py-3 lg:py-5 text-[#0073E6] border-b-2 border-[#0073E6]"
          >
            My Assessments
          </a>
          <a
            href="#2"
            className="tab text-[0.875rem] px-2 md:px-4 whitespace-nowrap h-auto tab-bordered font-semibold py-3 lg:py-5 text-[#1C4980] border-transparent"
          >
            Unstop Assessments
          </a>
        </div>
      ...
      <div className="lg:px-5 lg:pb-5 lg:pt-4 px-3 pb-3 pt-4">
        ...
        <div className="block lg:hidden">
          <MobileScreen show={showMobileScreen} />
        </div>
        {/* Desktop screen */}
        <h3 className=" font-medium text-lg text-[#1C4980] mb-4 hidden lg:block">
        ...
        <div className="flex justify-between lg:hidden">
          <h3 className=" font-medium text-lg text-[#1C4980] mb-4">
            My Assessment
          </h3>
          <div className="flex gap-1">
            <button
              onClick={() => {
                setbuttonState({ ...buttonState, search: !buttonState.search });
              }}
              className={
                "btn btn-sm lg:hover:bg-[#F2F8FE] btn-circle btn-link text-[#1C4980] " +
                (buttonState.search
                  ? "!text-[#0073E6] bg-[#F2F8FE] hover:bg-[#F2F8FE] border-[#0073E6] hover:border-[#0073E6]"
                  : "")
              }
            >
              <svg
            ...
            <button
              onClick={() => {
                setbuttonState({ ...buttonState, filter: !buttonState.filter });
              }}
              className={
                "btn btn-sm lg:hover:bg-[#F2F8FE] btn-circle btn-link text-[#1C4980] " +
                (buttonState.filter
