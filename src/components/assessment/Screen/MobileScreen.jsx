...
function MobileScreen({ show }) {
    return (
        <>
            <div className="collapse bg-transparent duration-300">
                <input type="checkbox" className='hidden' checked={show} readOnly/>
                <div className="collapse-content !p-0 bg-white">
                    <div className=" w-full rounded-box border mb-8 flex-wrap overflow-hidden flex">
                        <div className="flex w-full border-b">
                            <div className="py-3 px-4 border-r w-1/2">
                                <h4 className='text-[#1C4980] text-[0.875rem] font-semibold mb-3'>Total Assessment</h4>
                            ...
                            <div className="py-3 px-4 w-1/2">
                                <h4 className='text-[#1C4980] text-[0.875rem] font-semibold mb-3'>Total Purpose</h4>
                                <div className="flex gap-3 items-center">
                                    <div className=''>
