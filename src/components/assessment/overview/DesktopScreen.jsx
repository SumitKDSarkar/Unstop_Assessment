...
function DesktopScreen() {
    return (
        <div className=" w-full rounded-box border mb-8 flex-wrap overflow-hidden flex">
            <div className="py-4 px-5 border-r">
                <h4 className='text-[#1C4980] text-[0.875rem] font-semibold mb-4'>Total Assessment</h4>
                <div className="flex gap-3 items-center">
                    <div className='p-[0.6rem] rounded-lg bg-[#EBE8FD]'>
                    ...
                    <h4 className=' font-bold text-xl text-[#1C4980]'>34</h4>
                </div>
            </div>
            <div className="py-4 px-5 border-r flex-auto">
                <h4 className='text-[#1C4980] text-[0.875rem] font-semibold mb-4'>Candidates</h4>
                <div className="flex">
                    <div className="border-r pr-4 flex gap-3 items-center">
                        <div className=''>
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                                <rect width="40" height="40" rx="8" fill="#EBE8FD" />
                                <mask id="mask0_0_489" maskUnits="userSpaceOnUse" x="10" y="10" width="20" height="20">
                        ...
                        <div className="flex flex-col">
                            <h4 className=' font-bold text-xl text-[#1C4980] flex items-center gap-1'>11,145 <span className='text-[#05C165] text-xs'>+89</span></h4>
                            <p className=' text-xs font-medium text-[#1C4980]'>Total Candidate</p>
                        </div>
                    </div>
                    <div className="border-l pl-4 flex gap-3 items-center">
                        <div className="flex flex-col">
                            <h4 className=' font-bold text-xl text-[#1C4980] flex items-center gap-1'>1,14 <span className='text-[#05C165] text-xs'>+89</span></h4>
            ...
            <div className="py-4 px-5 border-r flex-auto">
                <h4 className='text-[#1C4980] text-[0.875rem] font-semibold mb-4'>Candidates Source</h4>
                <div className="flex">
                    <div className="border-r pr-4 flex gap-3 items-center">
                        <div className=''>
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                                <rect width="40" height="40" rx="8" fill="#FCE8EF" />
                                <mask id="mask0_0_508" maskUnits="userSpaceOnUse" x="10" y="10" width="20" height="20">
                                    <rect x="10" y="10" width="20" height="20" fill="#D9D9D9" />
                                </mask>
                        ...
                        <div className="flex flex-col">
                            <h4 className=' font-bold text-xl text-[#1C4980] flex items-center gap-1'>11,000 <span className='text-[#05C165] text-xs'>+89</span></h4>
                            <p className=' text-xs font-medium text-[#1C4980]'>E-mail</p>
                        </div>
                    </div>
                    <div className="border-x px-4 flex gap-3 items-center">
                        <div className="flex flex-col">
                            <h4 className=' font-bold text-xl text-[#1C4980] flex items-center gap-1'>145 <span className='text-[#05C165] text-xs'>+89</span></h4>
                ...
                <div className="flex gap-3 items-center">
                    <div className=''>
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                            ...
                            <mask id="mask0_0_533" maskUnits="userSpaceOnUse" x="10" y="10" width="20" height="20">
                                <rect x="10" y="10" width="20" height="20" fill="#D9D9D9" />
                            </mask>
                    ...
                    <h4 className=' font-bold text-xl text-[#1C4980]'>11</h4>
                </div>
            </div>
        </div>
    )
